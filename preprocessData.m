function [raw, enabled_ch_names, new_order, stim_data, t, channelInfo]=preprocessData()
...
%     [enabled_ch_names new_order]=loadData;
    ...
    channelInfo = extractInfo(enabled_ch_names, new_order, stim_data, t, processing_path);
end